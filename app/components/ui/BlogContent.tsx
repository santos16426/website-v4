              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 px-3 py-1.5 text-sm text-foreground/70 hover:text-white bg-white/5 hover:bg-white/10 rounded-lg border border-white/10 hover:border-emerald-400/30 transition-all duration-200"
                    title="Copy link"
                  >
                    {copied ? (
                      <>
                  ...
                  <motion.button
                    onClick={(e) => {
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="p-2 text-foreground/50 hover:text-blue-400 transition-colors"
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.95 }}
                      className="p-2 text-foreground/50 hover:text-blue-600 transition-colors"
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.95 }}
                      className="p-2 text-foreground/50 hover:text-blue-700 transition-colors"
