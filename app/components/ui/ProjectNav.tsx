        ...
        <div className="flex flex-col gap-0.5">
          {items.map((item) => (
            <button
              ...
              className="text-left transition-all duration-200 group relative"
            >
              <span
                className={`text-sm transition-all duration-200 block py-1.5 px-1 ${
                  activeId === item.id
                    ? "text-white font-medium pl-5 text-wrap"
